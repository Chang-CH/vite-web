...
then the variable is autoboxed into a special reference type. This means that **if the variable is reassigned, the closure will see the new value**. Here's an example to illustrate:
